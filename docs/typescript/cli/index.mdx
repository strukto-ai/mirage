...
`SKILL.md` under `plugins/mirage/skills/<cli>/`, because there is no
real program an agent already knows to fall back on; `git`, `gh`,
`psql` and `redis-cli` mirror a real program and ship none. Once a CLI
