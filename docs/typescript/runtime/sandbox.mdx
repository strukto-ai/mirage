...
A sandbox runs whole lines; it does not evaluate expressions. To make one
also serve as an [evaluator](/home/evaluator) (the capability behind route
scripts and the python console), subclass it and implement `eval` with your
own transport. The
