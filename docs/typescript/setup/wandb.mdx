...
```typescript
import { Workspace, MountMode, WandbVFS, normalizeWandbConfig } from '@struktoai/mirage-node'

const ws = new Workspace({
  '/wandb': new WandbVFS(normalizeWandbConfig({
    entities: ['my-team'],
...
The VFS also ships in `@struktoai/mirage-browser`; its implementation uses
