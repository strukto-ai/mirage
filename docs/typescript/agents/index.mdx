...
<CardGroup cols={2}>
  ...
  <Card title="DeepSeek Harness" icon="/images/deepseek-logo.svg" href="/typescript/agents/dsh">
    Cordis plugins that back dsh's `ctx.fs` and `ctx.shell` seams with a Mirage workspace.
  </Card>
</CardGroup>
