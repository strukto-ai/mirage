...
| --- | --- | --- | --- |
| DeepSeek Harness (this page) | its filesystem and shell | objects in your process — no subprocess, roughly 0.5 ms and 240 KB each | thousands (about 100 with a live Python engine, ~55 MB each) |
