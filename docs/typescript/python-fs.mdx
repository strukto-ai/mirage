...
See the full demo at [`examples/typescript/python/pyodide_vfs.ts`](https://github.com/strukto-ai/mirage/blob/main/examples/typescript/python/pyodide_vfs.ts).
...
```bash
node --experimental-wasm-jspi --import tsx/esm examples/typescript/python/pyodide_vfs.ts
```
...
- [`examples/typescript/python/pyodide_vfs.ts`](https://github.com/strukto-ai/mirage/blob/main/examples/typescript/python/pyodide_vfs.ts): runnable demo across RAM, S3, GDocs, Linear
