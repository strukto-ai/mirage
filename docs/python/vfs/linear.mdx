...
---
The Linear VFS exposes Linear workspace data as a virtual filesystem
...
The Linear VFS uses `IndexCacheStore` (same as Discord and other
mounts). There is no separate content cache -- file content caching
