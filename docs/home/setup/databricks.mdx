...
description: Set up Databricks credentials for the Unity Catalog volume VFS.
---

## Credentials

The VFS reads a Unity Catalog volume over the Databricks SDK. It needs a
...
For Python configuration, see the [Python Databricks Volume VFS](/python/vfs/databricks_volume) page.
