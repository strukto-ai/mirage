...
title: OneDrive
icon: microsoft
description: Get a Microsoft Graph access token and drive ID for the OneDrive VFS.
---

The OneDrive VFS talks to Microsoft OneDrive and SharePoint document
...
For Python configuration, see the [Python OneDrive VFS](/python/vfs/onedrive) page.
