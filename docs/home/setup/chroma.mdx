...
description: Prepare a ChromaDB collection for the Chroma VFS.
---
...
The Python VFS connects via Chroma's `AsyncHttpClient`.
...
For Python configuration, see the [Python Chroma VFS](/python/vfs/chroma) page.
