...
description: Set up Tencent Cloud Object Storage (COS) credentials for the Tencent VFS.
---
...
For Python configuration, see the [Tencent VFS](/python/vfs/tencent) docs.
