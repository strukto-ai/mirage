...
title: QingStor
icon: cloud
description: Set up QingStor (QingCloud) Object Storage credentials for the QingStor VFS.
---
...
For Python configuration, see the [QingStor VFS](/python/vfs/qingstor) docs.
