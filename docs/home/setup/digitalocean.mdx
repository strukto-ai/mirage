...
description: Set up DigitalOcean Spaces credentials for the DigitalOcean VFS.
---
...
For Python configuration, see the [DigitalOcean VFS](/python/vfs/digitalocean) docs.
