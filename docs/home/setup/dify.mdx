...
description: Set up a Dify Knowledge API key and dataset for the Dify VFS.
---
...
the Dify VFS config and use `name: path` in Dify metadata.
...
For Python configuration, see the [Python Dify VFS](/python/vfs/dify) page.
