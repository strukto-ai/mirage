...
| MinIO | read, write | [S3](/home/setup/s3) | [<Icon icon="python" />](/python/resource/s3_compatible) | Self-hosted S3-compatible store |
| Ceph | read, write | [S3](/home/setup/s3) | [<Icon icon="python" />](/python/resource/s3_compatible) | Ceph Rados Gateway (self-hosted) |
| Wasabi | read, write | [S3](/home/setup/s3) | [<Icon icon="python" />](/python/resource/s3_compatible) | Low-cost S3-compatible cloud |
| Backblaze B2 | read, write | [S3](/home/setup/s3) | [<Icon icon="python" />](/python/resource/s3_compatible) | B2 via S3 API |
| DigitalOcean Spaces | read, write | [S3](/home/setup/s3) | [<Icon icon="python" />](/python/resource/s3_compatible) | DO Spaces via S3 API |
| Tencent COS | read, write | [S3](/home/setup/s3) | [<Icon icon="python" />](/python/resource/s3_compatible) | Tencent Cloud Object Storage |
| Alibaba OSS | read, write | [S3](/home/setup/s3) | [<Icon icon="python" />](/python/resource/s3_compatible) | Aliyun Object Storage Service |
| Scaleway | read, write | [S3](/home/setup/s3) | [<Icon icon="python" />](/python/resource/s3_compatible) | Scaleway Object Storage |
| QingStor | read, write | [S3](/home/setup/s3) | [<Icon icon="python" />](/python/resource/s3_compatible) | QingCloud Object Storage |
