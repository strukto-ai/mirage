...
| Codex (CLI and app) | [<Icon icon="python" />](/python/agents/codex) [<Icon icon="node-js" />](/typescript/agents/codex) | TypeScript plugin with Mirage tools and stale-write protection; FUSE remains available. |
| Grok Build | [<Icon icon="node-js" />](/typescript/agents/grok-build) | Grok plugin with Mirage tools in the native TUI. |
