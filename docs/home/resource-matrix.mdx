...
| Redis | read, write, exec | [<Icon icon="python" />](/python/resource/redis) [<Icon icon="node-js" />](/typescript/setup/redis) [<Icon icon="globe" />](/typescript/setup/redis#browser) | Persistent cache-backed workspace; a browser reaches it through a REST front (Upstash, or serverless-redis-http over any Redis) |
| Upstash Redis | read, write, exec | [<Icon icon="python" />](/python/resource/redis) [<Icon icon="node-js" />](/typescript/setup/upstash) [<Icon icon="globe" />](/typescript/setup/upstash) | Hosted Redis with a REST door; one `rediss://` URL configures Python, Node and the browser |
...
| HF Datasets | read | [HF Datasets](/home/setup/hf_datasets) | [<Icon icon="python" />](/python/resource/hf_datasets) [<Icon icon="node-js" />](/typescript/setup/hf_datasets) | Hugging Face Dataset repos; the `hf` CLI commits |
| HF Models | read | [HF Models](/home/setup/hf_models) | [<Icon icon="python" />](/python/resource/hf_models) [<Icon icon="node-js" />](/typescript/setup/hf_models) | Hugging Face Model repos, weights stream on demand; the `hf` CLI commits |
| HF Spaces | read | [HF Spaces](/home/setup/hf_spaces) | [<Icon icon="python" />](/python/resource/hf_spaces) [<Icon icon="node-js" />](/typescript/setup/hf_spaces) | Hugging Face Space repos; the `hf` CLI commits |
