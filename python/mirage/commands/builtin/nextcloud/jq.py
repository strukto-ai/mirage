...
from mirage.core.nextcloud.stat import stat as _stat_async
from mirage.core.nextcloud.stream import read_stream as _stream
...
@command("jq", resource="nextcloud", spec=SPECS["jq"], provision=jq_provision)
async def jq(
    accessor: NextcloudAccessor,
    paths: list[PathSpec],
    *texts: str,
