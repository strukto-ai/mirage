...
from mirage.core.gslides.create import create_presentation
...
@command("gws-slides-presentations-create",
         ...
         spec=SPEC,
         write=True)
async def gws_slides_presentations_create(
    ...
    **_extra: object,
    ...
    if not json_str or not isinstance(json_str, str):
        raise ValueError('Usage: gws-slides-presentations-create '
                         '--json \'{"title": "My Deck"}\'')
