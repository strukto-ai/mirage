...
@command("ls", resource="redis", spec=SPECS["ls"], filetype=".arrow")
@command("ls", resource="redis", spec=SPECS["ls"], filetype=".ipc")
@command("ls", resource="redis", spec=SPECS["ls"], filetype=".feather")
