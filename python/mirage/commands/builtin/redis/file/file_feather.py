...
@command("file", resource="redis", spec=SPECS["file"], filetype=".arrow")
@command("file", resource="redis", spec=SPECS["file"], filetype=".ipc")
@command("file", resource="redis", spec=SPECS["file"], filetype=".feather")
