...
# the gws_* Workspace commands instead. gdrive's native read_stream is a
# coroutine returning bytes-or-iterator (Workspace-aware), so the stream op
# is synthesized from the whole-file read instead.
OPS = CommandIO(
    readdir=_readdir,
    read_bytes=_read,
