...
@command("ls", resource="gdrive", spec=SPECS["ls"], filetype=".arrow")
@command("ls", resource="gdrive", spec=SPECS["ls"], filetype=".ipc")
@command("ls", resource="gdrive", spec=SPECS["ls"], filetype=".feather")
