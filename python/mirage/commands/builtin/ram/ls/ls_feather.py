...
@command("ls", resource="ram", spec=SPECS["ls"], filetype=".arrow")
@command("ls", resource="ram", spec=SPECS["ls"], filetype=".ipc")
@command("ls", resource="ram", spec=SPECS["ls"], filetype=".feather")
