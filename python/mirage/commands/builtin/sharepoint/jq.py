...
from mirage.core.sharepoint.stat import stat as _stat_async
from mirage.core.sharepoint.stream import read_stream as _stream
...
@command("jq", resource="sharepoint", spec=SPECS["jq"], provision=jq_provision)
async def jq(
    accessor: SharePointAccessor,
    paths: list[PathSpec],
    *texts: str,
