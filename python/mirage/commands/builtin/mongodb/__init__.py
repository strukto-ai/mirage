...
# down to MongoDB queries, tail follows via change streams (tail -f), and cat
# dispatches by path (native document streaming vs rendered .json metadata,
...
_MONGODB_OVERRIDES = {"cat", "find", "grep", "rg", "tail"}
