...
from mirage.core.gridfs.identity import live_identity as core_live_identity
from mirage.ops.registry import op
from mirage.ops.types import LiveFileIdentity
from mirage.types import PathSpec


@op("live_identity", resource="gridfs")
async def live_identity(accessor: GridFSAccessor, path: PathSpec, *, index,
                        **kwargs) -> LiveFileIdentity:
    """Bounded identity lookup, bypassing the index cache entirely.

    Args:
        accessor (GridFSAccessor): backend accessor.
