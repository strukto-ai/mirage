...
EXIT_CODE_CASES: list[tuple[str, str]] = [
    ...
    ("sym_readlink_rel",
     "ln -s a.txt /data/sub/rellink && readlink /data/sub/rellink"),
    ("sym_readlink_nonlink", "readlink /data/a.txt"),
    ("sym_cd_through",
     "ln -s /data/sub /data/sublink && (cd /data/sublink && pwd)"),
    ("sym_cd_eloop",
     "ln -s /data/c2 /data/c1 && ln -s /data/c1 /data/c2 && (cd /data/c1) 2>&1"
     ),
