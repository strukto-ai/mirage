...
export interface SeaweedFSConfig extends S3AliasConfig {
  endpoint: string
}

export type SeaweedFSConfigRedacted = S3AliasConfigRedacted

const alias = makeFixedAlias<SeaweedFSConfig, SeaweedFSConfigRedacted>()
