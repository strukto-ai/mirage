...
import { S3ConfigSchema as S3CoreConfigSchema } from '@struktoai/mirage-core/vfs/s3/config'
import type { S3Config as S3CoreConfig } from '@struktoai/mirage-core/vfs/s3/config'
import {
