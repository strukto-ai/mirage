...
import { resolveGlob } from '../../../core/sscholar/glob.ts'
import { readdir as coreReaddir } from '../../../core/sscholar/readdir.ts'
import { stat as coreStat } from '../../../core/sscholar/stat.ts'
...
export const SSCHOLAR_LS = command({
  name: 'ls',
