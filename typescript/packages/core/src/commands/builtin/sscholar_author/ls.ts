...
import { resolveGlob } from '../../../core/sscholar/author_glob.ts'
import { readdir as coreReaddir } from '../../../core/sscholar/author_readdir.ts'
import { stat as coreStat } from '../../../core/sscholar/author_stat.ts'
...
export const SSCHOLAR_AUTHOR_LS = command({
  name: 'ls',
