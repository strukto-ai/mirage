...
const CASES: [string, string, string, string, number][] = [
  [
    'elements_and_count',
    'declare -A m; m[alpha]=1; m[beta]=2; echo "${m[alpha]}|${m[beta]}|${#m[@]}"',
    '1|2|2\n',
    '',
    0,
  ],
  ...
  ['empty_literal_renders_parens', 'declare -A m=(); declare -p m', 'declare -A m=()\n', '', 0],
  [
    'pairs_literal',
  ...
  [
    'pairs_odd_tail_empty',
    'declare -A m=(k1 v1 k2); declare -p m',
  ...
  [
    ...
    'declare -A m=([a]=1 b 2); declare -p m',
    'declare -A m=([a]="1" )\n',
  ...
  [
    'dollar_key_expands',
    'k=alpha; declare -A m; m[$k]=v; echo "${m[alpha]}|${m[$k]}"',
    'v|v\n',
    '',
    0,
  ],
  [
    'quoted_key_unquotes',
    'declare -A m; m["qk"]=v; declare -p m',
    'declare -A m=([qk]="v" )\n',
    '',
    0,
  ],
  ...
  ['element_append', 'declare -A m; m[k]=ab; m[k]+=cd; echo "${m[k]}"', 'abcd\n', '', 0],
  [
  ...
  [
    'whole_assign_replaces',
    'declare -A m=([a]=1); m=([b]=2); declare -p m',
    'declare -A m=([b]="2" )\n',
    '',
    0,
  ],
  [
    'scalar_assign_is_key_zero',
    'declare -A m=([a]=1); m=x; declare -p m',
    'declare -A m=([0]="x" [a]="1" )\n',
    '',
    0,
  ],
  [
    'indexed_scalar_assign_keeps_tail',
    'a=(1 2); a=x; declare -p a',
    'declare -a a=([0]="x" [1]="2")\n',
    '',
    0,
  ],
  [
    'unset_element',
    'declare -A m=([a]=1 [b]=2); unset "m[a]"; declare -p m',
    'declare -A m=([b]="2" )\n',
    '',
    0,
  ],
  ...
  [
    ...
    'declare -A m=([a]=1); unset "m[a]"; declare -p m',
    'declare -A m=()\n',
    '',
    0,
  ],
  ...
  [
    ...
    'declare -A m=([a]=hello); echo "${#m[a]}|${#m[@]}|${#m}"',
    '5|1|0\n',
    '',
    0,
  ],
  ...
  [
    'case_op_per_element',
    'declare -A m=([a]=hello); echo "${m[a]^^}|${m[@]^^}"',
    'HELLO|HELLO\n',
    '',
    0,
  ],
  [
    ...
    'declare -A m=([a]=1 [b]=2 [c]=3); echo "${m[@]:0:2}"; echo "${m[@]: -1}"',
    '1 2\n3\n',
    '',
    0,
  ],
  ...
  [
    ...
    'declare -A m=([b]=2 [a]=1); for k in "${!m[@]}"; do echo "$k=${m[$k]}"; done',
    'a=1\nb=2\n',
    '',
    0,
  ],
  [
    'arith_literal_key',
    'declare -A m=([abc]=7); x=abc; echo "$((m[x])) $((m[$x])) $((m[abc]))"',
    '0 7 7\n',
    '',
    0,
  ],
  ['arith_nested_key_text', 'declare -A m=([k5]=9); i=5; echo $((m[k$i]))', '9\n', '', 0],
  ...
  [
    'test_v_key_membership',
    'declare -A m=([k]=v); [[ -v m[k] ]]; echo $?; [[ -v m[zz] ]]; echo $?; test -v "m[k]"; echo $?',
    '0\n1\n0\n',
    '',
    0,
  ],
  ...
  [
    'scalar_converts_to_key_zero',
    's=5; declare -A s; declare -p s',
    'declare -A s=([0]="5" )\n',
    '',
    0,
  ],
  ...
  [
    'empty_subscript_fatal',
    'e=; declare -A m; m[$e]=v; echo unreached',
    '',
  ...
  [
    'local_A_shadows',
    'f(){ local -A m=([k]=inner); echo "${m[k]}"; }; declare -A m=([k]=outer); f; echo "${m[k]}"',
    'inner\nouter\n',
    '',
    0,
  ],
  [
    'readonly_A_renders_Ar',
    'readonly -A r2=([k]=v); declare -p r2',
    'declare -Ar r2=([k]="v" )\n',
    '',
    0,
  ],
  ...
  [
    'read_into_element',
    'declare -A m; read "m[k]" <<< hello; declare -p m',
    'declare -A m=([k]="hello" )\n',
    '',
    0,
  ],
  ...
  [
    'indexed_literal_subscripts',
    'a=([3]=x y [1]=z); declare -p a',
  ...
  [
    'i_declared_value_coerces',
    'declare -i n=3+4; echo "$n"; declare -p n',
    '7\ndeclare -i n="7"\n',
    '',
    0,
  ],
  ...
  [
    'i_var_reference',
    'x=6; declare -i n; n=x+1; echo "$n"; n="x * 2"; echo "$n"',
    '7\n12\n',
    '',
    0,
  ],
  [
    'i_bad_expr_fatal',
    'declare -i n; n=1+; echo unreached',
    '',
    'bash: 1+: syntax error: operand expected\n',
    1,
  ],
  ['i_div_zero_fatal', 'declare -i n; n=1/0; echo unreached', '', 'bash: 1/0: division by 0\n', 1],
  [
    'i_append_adds',
    'declare -i n=5; n+=3; echo "$n"; declare -p n',
    '8\ndeclare -i n="8"\n',
    '',
    0,
  ],
  ...
  [
    'i_existing_keeps_text',
    'v=2+2; declare -i v; echo "$v"; declare -p v',
    '2+2\ndeclare -i v="2+2"\n',
    '',
    0,
  ],
  [
    'i_bare_stays_unset',
    'declare -i n; declare -p n; echo "|${n-unset}|"',
    'declare -i n\n|unset|\n',
    '',
    0,
  ],
  ...
  [
    'i_export_cluster',
    'declare -ix n=2+2; declare -p n; env | grep "^n="',
    'declare -ix n="4"\nn=4\n',
    '',
    0,
  ],
  [
    'i_readonly_cluster',
    'declare -ir n=2+2; declare -p n; n=5; echo x',
    'declare -ir n="4"\n',
  ...
  ['i_printf_v_coerces', 'declare -i n; printf -v n "%s" "2*8"; echo "$n"', '16\n', '', 0],
  ['i_default_op_coerces', 'declare -i n; : "${n:=3+3}"; echo "$n"', '6\n', '', 0],
  [
    'i_read_bad_refuses',
    'declare -i n; read n <<< "1+"; echo "rc=$? |$n|"',
    'rc=1 ||\n',
  ...
  [
    ...
    'declare -i n; printf -v n "%s" "1+"; echo "rc=$? |$n|"',
    'rc=1 ||\n',
    'bash: printf: 1+: syntax error: operand expected\n',
    0,
  ],
  [
    'i_declare_bad_continues',
    'declare -i n=1+; echo "rc=$? |$n|"',
    'rc=1 ||\n',
  ...
  [
    ...
    'declare -i n; export n=1+1; echo "$n"; declare -i m; readonly m=2+2; echo "$m"; declare -p n m',
    '2\n4\ndeclare -ix n="2"\ndeclare -ir m="4"\n',
    '',
    0,
  ],
  ...
  [
    'l_existing_keeps_text',
    'v=MiXeD; declare -l v; echo "$v"; declare -p v',
    'MiXeD\ndeclare -l v="MiXeD"\n',
    '',
    0,
  ],
  [
    ...
    'declare -lu s=aBc; echo "$s"; declare -p s; declare -ul t=aBc; declare -p t',
    'aBc\ndeclare -- s="aBc"\ndeclare -- t="aBc"\n',
    '',
    0,
  ],
  ...
  [
    ...
    'declare -l s; read s <<< "HeLLo"; echo "$s"; printf -v s "%s" "AbC"; echo "$s"; declare -l t; : "${t:=XYZ}"; echo "$t"',
    'hello\nabc\nxyz\n',
    '',
    0,
  ],
  ['li_combo_order', 'declare -li n=1+1; echo "$n"; declare -p n', '2\ndeclare -il n="2"\n', '', 0],
  [
    'l_export_kw',
    'declare -l s; export s=ABC; echo "$s"; declare -p s',
    'abc\ndeclare -xl s="abc"\n',
    '',
    0,
  ],
  ...
  [
    'u_readonly_cluster',
    'declare -ur s=abc; echo "$s"; declare -p s',
    'ABC\ndeclare -ru s="ABC"\n',
    '',
    0,
  ],
  [
    't_stored_and_printed',
    'declare -t v=1; declare -p v; declare +t v; declare -p v',
    'declare -t v="1"\ndeclare -- v="1"\n',
    '',
    0,
  ],
  ...
  [
    'plus_a_refused',
    'a=(1); declare +a a; echo rc=$?; declare -p a',
    'rc=1\ndeclare -a a=([0]="1")\n',
  ...
  [
    'plus_A_refused',
    'declare -A m=([k]=v); declare +A m; echo rc=$?',
    'rc=1\n',
  ...
  [
    'plus_multi_letters',
    'declare -xi n=1; declare +xi n; declare -p n',
    'declare -- n="1"\n',
    '',
    0,
  ],
  [
    'plus_creates_unset',
    'declare +x NEVER; echo rc=$?; declare -p NEVER',
    'rc=0\ndeclare -- NEVER\n',
    '',
    0,
  ],
  ...
  ['minus_plus_mix', 'declare -i +x n=1+1; declare -p n', 'declare -i n="2"\n', '', 0],
  [
    'plus_export_kw_refused',
    'export V=1; export +x V; echo rc=$?',
    'rc=1\n',
    "bash: export: `+x': not a valid identifier\n",
    0,
  ],
  [
    'plus_readonly_kw_refused',
    'readonly +r R; echo rc=$?',
    'rc=1\n',
  ...
  // array name reads as element 0 in arithmetic, `-i` resolves element
  // references at the write, and `test -v` unquotes an associative
  // subscript. `${a[-5]:=v}` diverges by one line: GNU also warns
  // `a: bad array subscript` for the read, and expansion has no warning
  // channel here.
  [
    'assoc_default_colon',
  ...
  [
    'assoc_default_eq',
    'declare -A m; echo "${m[k]=v}"; declare -p m',
    'v\ndeclare -A m=([k]="v" )\n',
    '',
    0,
  ],
  [
    'indexed_default_new_index',
    'a=(1 2); echo "${a[3]:=v}"; declare -p a',
    'v\ndeclare -a a=([0]="1" [1]="2" [3]="v")\n',
    '',
    0,
  ],
  [
    'indexed_default_neg_set',
    'a=(1 2); echo "${a[-1]:=v}"; declare -p a',
    '2\ndeclare -a a=([0]="1" [1]="2")\n',
    '',
    0,
  ],
  [
    'indexed_default_neg_out',
    'a=(1 2); echo "${a[-5]:=v}"; echo after',
    '',
  ...
  [
    'indexed_default_unset',
    'unset a; echo "${a[2]:=v}"; declare -p a',
    'v\ndeclare -a a=([2]="v")\n',
    '',
    0,
  ],
  [
    'indexed_default_scalar',
    'x=s; echo "${x[1]:=v}"; declare -p x',
    'v\ndeclare -a x=([0]="s" [1]="v")\n',
    '',
    0,
  ],
  ...
  [
    'arith_order_elem_then_bare',
    'a=(0); ((a[0]=1, a=2)); declare -p a',
    'declare -a a=([0]="2")\n',
    '',
    0,
  ],
  [
    'arith_order_bare_then_elem',
    'a=(0); ((a=2, a[0]=1)); declare -p a',
    'declare -a a=([0]="1")\n',
    '',
    0,
  ],
  [
    'arith_bare_keeps_tail',
    'a=(1 2 3); ((a=5)); declare -p a',
  ...
  ['int_reads_indexed_element', 'a=(1 2); declare -i n; n="a[1]+1"; echo $n', '3\n', '', 0],
  [
    'int_reads_assoc_element',
    'declare -A m=([x]=4); declare -i n; n="m[x]+1"; echo $n',
    '5\n',
    '',
    0,
  ],
  ...
  ['int_missing_element_is_zero', 'a=(1 2); declare -i n; n="a[5]+1"; echo $n', '1\n', '', 0],
  [
  ...
  [
    ...
    'declare -A m=([\'"x"\']=1); test -v \'m["x"]\' && echo yes || echo no; declare -p m',
    'no\ndeclare -A m=(["\\"x\\""]="1" )\n',
    '',
    0,
  ],
  ...
  ['arith_bare_assoc_read', 'declare -A m=([0]=7 [x]=1); echo $((m+1))', '8\n', '', 0],
