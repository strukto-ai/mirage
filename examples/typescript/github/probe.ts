...
async function main(): Promise<void> {
  ...
  console.log('--- ls /github/python/mirage/vfs ---')
  let r = await ws.shell('ls /github/python/mirage/vfs')
  console.log(r.stdoutText)
  console.log('--- stat /github/python/mirage/vfs/base.py ---')
  r = await ws.shell('stat /github/python/mirage/vfs/base.py')
  console.log('STDOUT:', r.stdoutText)
  console.log('STDERR:', r.stderrText)
  console.log('EXIT:', r.exitCode)
  console.log('--- cat /github/python/mirage/vfs/base.py | head -n 5 ---')
  r = await ws.shell('cat /github/python/mirage/vfs/base.py | head -n 5')
